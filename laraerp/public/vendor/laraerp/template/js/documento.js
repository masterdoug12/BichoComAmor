(function ($) {
    ...
    function documentoParams(){
        ...
        $.post('/laraerp/public/util/parametrosReceita', {documento: documento}, function (json) {
    ...
    function consultar(nascimento, captcha, cookie) {
        ...
        $.post('/laraerp/public/util/consultaReceita', {nascimento: nascimento, documento: documento, captcha: captcha, cookie: cookie}, function (json) {
